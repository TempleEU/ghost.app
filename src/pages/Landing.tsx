...
export default function Landing() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border/60"><div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-6 text-xs text-muted-foreground"><span>Ghost.app — Private by design. Secure by default.</span><span>Android available · other platforms in development</span></div></footer>
    </motion.div>
  );
}
